...
BASE_DIR = '/home/zhanghl/projects/ddc_github/runs/run_005'
DATA_DIR = os.path.join(BASE_DIR, 'data')
PLOTS_DIR = os.path.join(BASE_DIR, 'plots')
RESULTS_DIR = os.path.join(BASE_DIR, 'results')

DIR_ENABLE = '/home/zhanghl/projects/ddc_github/test_convergence/v1_1_1_enable_resource_projection'
DIR_DISABLE = '/home/zhanghl/projects/ddc_github/test_convergence/v1_1_1_disable_resource_projection'
