...
| **Simulation Code Version** | v1.0; git commit: 384dd59 (src/ddc.py)      |
...
| ----------------------------------------------------- | ---------------------------------------- |
| `test_convergence/v1_1_1_enable_resource_projection`  | Worlds with resource projection enabled  |
| `test_convergence/v1_1_1_disable_resource_projection` | Worlds with resource projection disabled |
...
- **Forbidden**: Direct modification of protein state P, skipping resource projection, creating ΣP > R\_total states
...
```bash
python runs/run_005/scripts/run_005_analysis.py
```

Requires:

- Source data in `test_convergence/v1_1_1_enable_resource_projection` and `test_convergence/v1_1_1_disable_resource_projection`
